...
const models = [
  { path: '/models/PCICON.glb',          label: 'PC Icon',    tooltip: 'Criar',        route: '/create',         position: [ 9.0,  3.5,  0], scale: 0.36, rotationY: 60  * (Math.PI / 180),               floatSpeed: 0.6,  floatAmp: 0.12, floatPhase: Math.random() * Math.PI * 2 },
